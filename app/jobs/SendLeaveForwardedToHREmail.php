...
class SendLeaveForwardedToHREmail implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($recipients)->send(new LeaveForwardedToHRMail($leave));

        Log::info("LeaveForwardedToHRMail: sent to " . implode(', ', $recipients), [
            'leave_id' => $leave->id,
        ]);
    }
    ...
    {
        Log::error("LeaveForwardedToHRMail: permanently failed for leave {$this->leaveId}", [
